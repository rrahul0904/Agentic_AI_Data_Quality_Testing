with source as ({{ stage_raw_entity('oracle', 'EVENT_BOOKING') }})
select coalesce(raw_payload:EVENT_BOOKING_ID::varchar, source_primary_key) as event_booking_id,
       ...
       try_to_number(raw_payload:PARTY_SIZE) as attendee_count, {{ safe_cast_number('raw_payload:AMOUNT') }} as booking_amount,
