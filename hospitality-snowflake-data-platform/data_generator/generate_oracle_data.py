...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate simulated Oracle PMS CDC extracts")
    ...
    print(json.dumps(generate_relational_exports("oracle", args.scale, args.output, args.seed, args.max_rows), indent=2))
