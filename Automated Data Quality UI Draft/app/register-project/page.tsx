...
function connectionStatusLabel(status?: ConnectionTestResult["status"]): string {
  ...
  if (status === "FAIL" || status === "UNVERIFIED") return "Needs review";
  return "Not tested";
}
