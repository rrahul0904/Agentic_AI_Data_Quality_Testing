...
`ADE_DATA_DIFF_SOURCE_PLATFORM`, `ADE_DATA_DIFF_TARGET_PLATFORM`, `ADE_DATA_DIFF_SOURCE_TABLE`, `ADE_DATA_DIFF_TARGET_TABLE`, `ADE_DATA_DIFF_KEYS`; optional `ADE_DATA_DIFF_COMPARE_COLUMNS`, `ADE_DATA_DIFF_PARTITION_STRATEGY`, `ADE_DATA_DIFF_MAX_PARTITION_ROWS`, `ADE_DATA_DIFF_DETAIL_LIMIT`.
